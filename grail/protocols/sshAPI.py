"""SSH protocol handler for URLs of the form ssh://host[:port]
...
class ssh_access(null_access):
    ...
    def __init__(self, url, method, params):
        ...
        # ssh or xterm.  So we need to close all file descriptors,
